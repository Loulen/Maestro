...
4. **Smoke bash** (`tests/smoke.sh`) — pre-merge, gratuit : daemon démarre, `/runs` et `/pipelines` répondent JSON, `index.html` contient "Maestro", asset JS répond 200.
